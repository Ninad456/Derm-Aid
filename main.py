...
st.write(
    "Please enter your details and upload an image of your skin to identify potential diseases using our AI model.")
...
if st.button("Submit"):
    if uploaded_image is not None and patient_name and patient_age > 0 and \
        ...
        st.image(uploaded_image, caption='Uploaded Image', width=550)  # Show the image with medium size
        with st.spinner('Analyzing... Please wait'):
            ...
            if prediction:
                ...
                pdf.cell(0, 10, txt=f"Does anyone in your family have the same symptoms?: {family_symptoms}", ln=True,
                         align='L')
